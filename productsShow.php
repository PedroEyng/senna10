        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="formulario.php">Cadastre-se</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 col-sm-12">
                    ...
                    <p>Efetue o login em <a href="login.html"><strong>Login</strong></a> para comprar!</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="footer-menu">
                        <ul>
                            <li><a href="#">Home</a></li>
                            <li><a href="mailto:pedro.senna.fernandes@escola.pr.gov.br">Help</a></li>
